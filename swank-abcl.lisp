...
;;;
;;; swank-abcl.lisp --- Armedbear CL specific code for SLCLJ. 
;;;
...
(defimplementation make-output-stream (write-string)
  (ext:make-slclj-output-stream write-string))

(defimplementation make-input-stream (read-string)
  (ext:make-slclj-input-stream read-string  
...
http://article.gmane.org/gmane.lisp.slclj.devel/2425
