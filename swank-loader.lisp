...
;;;
;;; swank-loader.lisp --- Compile and load the Slclj backend.
;;;
...
(defun slclj-version-string ()
  "Return a string identifying the SLCLJ version.
...
(defun default-fasl-dir ()
  (merge-pathnames
   (make-pathname
    :directory `(:relative ".slclj" "fasl"
                 ,@(if (slclj-version-string) (list (slclj-version-string)))
                 ,(unique-dir-name)))
