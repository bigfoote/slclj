;;;
;;; swank-corman.lisp --- Corman Lisp specific code for SLCLJ.
;;;
...
;;; http://www.grumblesmurf.org/lisp/corman-patches, otherwise SLCLJ
;;; will blow up in your face.  You should also follow the
;;; instructions on http://www.grumblesmurf.org/lisp/corman-slclj.
;;;
;;; The only communication style currently supported is NIL.
;;;
;;; Starting CCL inside emacs (with M-x slclj) seems to work for me
...
;;; slclj-connect always works fine.
;;;
