...
(defslcljfun who-depends-on (system)
...
(defslcljfun operate-on-system-for-emacs (system-name operation &rest keywords)
...
(defslcljfun list-all-systems-in-central-registry ()
...
(defslcljfun list-all-systems-known-to-asdf ()
...
(defslcljfun asdf-system-files (name)
...
(defslcljfun asdf-determine-system (file buffer-package-name)
...
(defslcljfun delete-system-fasls (name)
  (let ((removed-count
...
(defslcljfun reload-system (name)
