;;;; slclj-indentation.el - cl-indent.el as a slclj-contrib module

(defun slclj-indentation-init ()
  (slclj-require :swank-indentation))

;; redefine this for cl-indent:method
(defun slclj-handle-indentation-update (alist)
  "Update Lisp indent information for slclj-indentation.el.
