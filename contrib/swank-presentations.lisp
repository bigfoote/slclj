...
;; rest of slclj isn't thread safe either), do we really care?
...
(defslcljfun lookup-presented-object-or-lose (id)
...
(defslcljfun clear-repl-results ()
...
(defslcljfun inspect-presentation (id reset-p)
