...
(defslcljfun fuzzy-completions (string default-package-name &key limit time-limit-in-msec)
...
(defslcljfun fuzzy-completion-selected (original-string completion)
  "This function is called by Slclj when a fuzzy completion is
